...
export const cardBack = { name: 'cardBack', file: cardBackImg };

export const jobImages = [
    { name: 'chef', file: chef },
    { name: 'chemist', file: chemist },
    { name: 'firefighter', file: firefighter },
    { name: 'gardener', file: gardener },
    { name: 'librarian', file: librarian },
    { name: 'mechanic', file: mechanic },
    { name: 'musician', file: musician },
    { name: 'painter', file: painter },
    { name: 'teacher', file: teacher },
    { name: 'vet', file: vet }
];