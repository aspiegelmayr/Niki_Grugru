...
export const topsOnNiki = [
    { name: 'top1OnNiki', file: top1OnNiki },
    { name: 'top2OnNiki', file: top2OnNiki },
    { name: 'top3OnNiki', file: top3OnNiki },
    { name: 'top4OnNiki', file: top4OnNiki },
    { name: 'top5OnNiki', file: top5OnNiki },
];

export const bottomsOnNiki = [
    { name: 'bottoms1OnNiki', file: bottoms1OnNiki },
    { name: 'bottoms2OnNiki', file: bottoms2OnNiki },
    { name: 'bottoms3OnNiki', file: bottoms3OnNiki },
    { name: 'bottoms4OnNiki', file: bottoms4OnNiki },
    { name: 'bottoms5OnNiki', file: bottoms5OnNiki },
    { name: 'bottoms6OnNiki', file: bottoms6OnNiki },
    { name: 'bottoms7OnNiki', file: bottoms7OnNiki },
    { name: 'bottoms8OnNiki', file: bottoms8OnNiki },
];

export const overallsOnNiki = [
    { name: 'overalls1OnNiki', file: overalls1OnNiki },
    { name: 'overalls2OnNiki', file: overalls2OnNiki },
];

export const shoesOnNiki = [
    { name: 'shoes1OnNiki', file: shoes1OnNiki },
    { name: 'shoes2OnNiki', file: shoes2OnNiki },
    { name: 'shoes3OnNiki', file: shoes3OnNiki },
    { name: 'shoes4OnNiki', file: shoes4OnNiki },
    { name: 'shoes5OnNiki', file: shoes5OnNiki },
];

export const accessoriesOnNiki = [
    { name: 'accessories1OnNiki', file: accessories1OnNiki },
    { name: 'accessories2OnNiki', file: accessories2OnNiki },
    { name: 'accessories3OnNiki', file: accessories3OnNiki },
    { name: 'accessories4OnNiki', file: accessories4OnNiki },
    { name: 'accessories5OnNiki', file: accessories5OnNiki },
    { name: 'accessories6OnNiki', file: accessories6OnNiki },
    { name: 'accessories7OnNiki', file: accessories7OnNiki },
];

export const hatsOnNiki = [
    { name: 'hat1OnNiki', file: hat1OnNiki },
