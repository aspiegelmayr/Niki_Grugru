        ...
        <Navbar.Collapse className="justify-content-end">
          <Nav className="me-auto">
            ...
            <NavDropdown title={<b style={{color: "#2a5069"}}>Games</b>} id="basic-nav-dropdown">
              ...
              <NavDropdown.Item href="/games/3" style={{color: "#2a5069"}}>Spiel 3</NavDropdown.Item>
              <NavDropdown.Item href="/games/4" style={{color: "#2a5069"}}>Spiel 4</NavDropdown.Item>
              <NavDropdown.Item href="/games/5" style={{color: "#2a5069"}}>Spiel 5</NavDropdown.Item>
            </NavDropdown>
